...
const features = [
  {
    name: 'Track Product Quickly',
    description:
      'Get product data online faster than ever with our Fast Track application. This tool allows you to easily enter product data into our system in seconds!',
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Gavelbase</span>
              <img
